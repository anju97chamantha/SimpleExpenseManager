...
public class PersistentDemoExpenseManager extends ExpenseManager {
    ...
    public PersistentDemoExpenseManager(Context context_) {
        dbHelper = new DBHelper(context_);
        context = context_;
        setup();
    ...
    public void setup() {
        ...
        AccountDAO persistentAccountDAO = new PersistentAccountDAO(dbHelper,context);
